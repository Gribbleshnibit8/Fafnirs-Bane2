...
public class AIPath2D : AIPath {
	...
	public override void Update() 
	{
		...
		Vector3 dir = CalculateVelocity2D (GetFeetPosition());
		
		//Rotate towards targetDirection (filled in by CalculateVelocity)
		// RotateTowards (targetDirection);			// Wesley Removed this since we don't want the sprite rotating
	 ...
	 */
	protected Vector3 CalculateVelocity2D(Vector3 currentPosition)
	{
		...
		Vector3 targetPosition = CalculateTargetPoint2D(currentPosition, vPath[currentWaypointIndex - 1], vPath[currentWaypointIndex]);
	 ...
	 * \see turningSpeed
	 */
	protected virtual void RotateTowards2D (Vector3 dir) {
	 ...
	 */
	protected Vector3 CalculateTargetPoint2D (Vector3 p, Vector3 a, Vector3 b) {
		a.z = p.z;
		b.z = p.z;
